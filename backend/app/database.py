...
def sync_postgres_schema() -> None:
    ...
    statements = [
        text('ALTER TABLE IF EXISTS users ADD COLUMN IF NOT EXISTS company_id TEXT'),
        ...
        text('ALTER TABLE IF EXISTS department ADD COLUMN IF NOT EXISTS company_id TEXT'),
        text('ALTER TABLE IF EXISTS company ADD COLUMN IF NOT EXISTS dept_id TEXT'),
        ...
        text('ALTER TABLE IF EXISTS upload_batch ADD COLUMN IF NOT EXISTS department_id TEXT'),
        text('ALTER TABLE IF EXISTS upload_batch ADD COLUMN IF NOT EXISTS uploaded_by TEXT'),
        ...
        text('ALTER TABLE IF EXISTS transaction ADD COLUMN IF NOT EXISTS department_id TEXT'),
        ...
        text('ALTER TABLE IF EXISTS transaction ADD COLUMN IF NOT EXISTS upload_batch_id TEXT'),
