...
class UUIDString(TypeDecorator):
    ...
    def load_dialect_impl(self, dialect):
        if dialect.name == "postgresql":
            # Keep UUIDs as uuid.UUID values through psycopg/SQLAlchemy so
            # bulk INSERT result sentinels use the same type as bound values.
...
Index("idx_upload_batch_file_hash", UploadBatch.department_id, UploadBatch.source_file_hash)
